...
int main(int argc, char *argv[])
{
    ...
    const int min_average = minSupIn;

    const int minimum_support_threshold = min_average*transactionsVector.size();

    const int minimum_diversification = minDivIn;

    // std::cout << "minAverage = " << min_average << " mindiv = " << minimum_diversification << std::endl;
